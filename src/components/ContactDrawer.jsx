          ...
          >
            ...
            >
              ...
              >
                {/* Schedule Call */}
                <motion.a
                  href="https://calendly.com/sanchay823/30min"
                  target="_blank"
                ...
                {/* Email */}
                <motion.a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=sanchay823@gmail.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`flex items-center gap-4 p-4 rounded-2xl transition-all group ${
                    theme === 'dark' 
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-slate-500 to-teal-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
