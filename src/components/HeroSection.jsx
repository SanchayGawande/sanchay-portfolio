...
const HeroSection = () => {
  ...
  // Mouse tracking for parallax with throttling to prevent excessive updates
  useEffect(() => {
    let rafId = null;
    let lastUpdate = 0;
    const throttleDelay = 50; // Update every 50ms (20fps)
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          ...
          >
            ...
            >
              Machine Learning and Software Engineer with 2+ years of experience building production ML and AI systems.
              Hands-on experience with LLM workflows including RAG, tool calling, and low-latency inference services
              using FastAPI, Docker, and PostgreSQL.
            </motion.p>
            ...
            >
              {[
                ...
                {
                  href: "mailto:sanchay823@gmail.com",
                  label: "Email Contact",
