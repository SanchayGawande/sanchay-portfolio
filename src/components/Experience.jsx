  ...
  const experiences = [
    {
      ...
      role: "Machine Learning & AI Engineer (Founding Team)",
      ...
      achievements: [
        ...
        "Defined retrieval quality and response regression checks for RAG workflows, improving iteration speed and reducing production debugging time",
        "Optimized AWS infrastructure (ECS, API Gateway) for cost and reliability, establishing monitoring for P99 latency across the orchestration layer"
      ],
    ...
    },
    {
      ...
      achievements: [
        ...
        "Designed internal utilities, debugging scripts, and deployment helpers that accelerated development velocity for multi-week team projects",
        "Completed recurring engineering challenges with strict deadlines, consistently ranking as a top performer"
      ],
    ...
    },
    {
      ...
      technologies: ["React", "Python", "Vector Search", "LLM", "Authentication", "State Management"],
      highlights: [
